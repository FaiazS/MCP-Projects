...
def financial_researcher_agent():
...
def investor_trader_instructions(name: str):
    ...
    return f""" You are {name}, a very well experienced and an elite trader/investor in the equity market. 
                ...
                3. You also have tools which can access financial data for equity. {note}.
...
def rebalance_equity_portfolio_message(name, investment_strategy, account_name):
    ...
    Use the provided tools to research equity price and related company information concerning your existing equity portfolio. {note}
